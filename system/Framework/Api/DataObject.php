<?php
	...
	class DataObject implements \Lenkenith\Framework\Api\DataObjectInterface {
	    /**
	     * Object attributes
	     *
	     * @var array
	     */
	    protected $_data = [], $_initial = [];
	    ...
	    public function getData($key = '', $index = null)
	    {
	     ...
	     public function getInitial($key = '', $index = null)
	    {
	        if ('' === $key) {
	            return $this->_initial;
	        }

	        return (isset($this->_initial[$key])) ? $this->_initial[$key] : false;
	    }
